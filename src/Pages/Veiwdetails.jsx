...
const Veiwdetails = () => {
  let dispatch = useDispatch()
    ...
    let filteredArr = allProducts.filter((item)=> item.category === obj.category)
      ...
      <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
          ...
          <div className="mt-6 bg-[#ffffff21] p-5 rounded-3xl sm:mt-8 lg:mt-0">
            ...
            >
              <AccordionSummary
                ...
                id="panel1-header"
              >
                <Typography component="span" className='text-amber-100 text-2xl'>Rating</Typography>
              </AccordionSummary>

              <AccordionDetails>
                <Typography>
                  <div>
                    <h1 className="text-blue-100 text-2xl">Reveiwers Ratings-- </h1>
          ...
          <div className=' p-2 text-[#f3f3f3] mt-3 '>
            <h1 className='text-center text-2xl mb-2 font-sans  font-semibold '>Related Project</h1>
                  ...
                  return (
                    <div className="bg-[#00000059] p-1">
                      ...
                      <div className='flex mb-2 justify-between'>
                        <button onClick={()=>dispatch(AddtoCart(ele))} className="w-[40%]   text-gray-900 bg-cyan-300 py-1.5 rounded-2xl hover:bg-blue-500 hover:text-white cursor-pointer">
                          Add to Cart
                        </button>{" "}
                        <button onClick={()=>dispatch(addtoWish(ele))} className="w-[40%] text-gray-900 bg-cyan-300 py-1.5 p-1 rounded-2xl hover:bg-blue-500 hover:text-white cursor-pointer">
                          Add to Wishlist
                        </button>
                      </div>
                    </div>
